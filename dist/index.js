...
const server = new Server({ name: "instacart-ca", version: "0.1.0" }, { capabilities: { tools: {} } });
server.setRequestHandler(ListToolsRequestSchema, async () => ({
    tools: [
        {
            name: "instacart_check",
            description: "Verify the MCP can reach your logged-in Chrome and that the instacart.ca session is active. Run this first if other tools return empty.",
            inputSchema: { type: "object", properties: {} },
        },
        {
            name: "instacart_search",
            description: "Search products in ONE Instacart Canada store. Returns product names and prices.",
            inputSchema: {
                type: "object",
                properties: {
        ...
        },
        {
            ...
            description: "Compare a product's price across ALL configured Instacart Canada stores. Returns the cheapest top match per store.",
            inputSchema: {
                type: "object",
                properties: {
