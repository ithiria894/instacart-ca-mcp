...
const server = new Server(
  { name: "instacart-ca-mcp", version: "0.1.0" },
  { capabilities: { tools: {} } }
);
...
const TOOLS = [
  {
    ...
    description:
      "Verify the Instacart.ca browser session is logged in. Returns loggedIn boolean and current URL.",
    inputSchema: { type: "object", properties: {}, additionalProperties: false },
  },
  {
    name: "instacart_search",
    description:
      "Search a single Instacart.ca store for a product query. Returns a name+price list.",
    inputSchema: {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    description:
      "Compare the price of a product across all configured Instacart.ca stores (" +
      STORE_NAMES +
