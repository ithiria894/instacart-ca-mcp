...
function readCookieString() {
    ...
    if (process.env.INSTACART_COOKIES)
        return process.env.INSTACART_COOKIES.trim();
    console.error("No cookies provided. Set INSTACART_COOKIES env or pass a file path argument.");
    process.exit(1);
}
...
async function main() {
    ...
    const check = await page.evaluate(async () => {
        const url = "/graphql?operationName=CurrentUserFields&variables=%7B%7D&extensions=%7B%22persistedQuery%22%3A%7B%22version%22%3A1%2C%22sha256Hash%22%3A%22d7d1050d8a8efb9a24d2fd0d9c39f58d852ab84ea709370bcbedbca790112952%22%7D%7D";
