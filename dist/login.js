...
const HASH_CURRENT_USER = "d7d1050d8a8efb9a24d2fd0d9c39f58d852ab84ea709370bcbedbca790112952";
async function isLoggedIn(ctx) {
    const page = ctx.pages()[0];
    if (!page)
        return false;
    try {
        const url = "/graphql?operationName=CurrentUserFields&variables=%7B%7D&extensions=" +
            encodeURIComponent(JSON.stringify({ persistedQuery: { version: 1, sha256Hash: HASH_CURRENT_USER } }));
